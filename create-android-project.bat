...
:: modify it to work under your environment
set _ANDROIDTOOLS=D:\android-sdk-windows\tools
if not exist "%_ANDROIDTOOLS%" echo Couldn't find android sdk tools at "%_ANDROIDTOOLS%" & pause & exit 5

:: modify it to work under your environment
set _NDKROOT=D:\android-sdk-windows\android-ndk-r8
if not exist "%_NDKROOT%" echo Couldn't find ndk at "%_NDKROOT%" & pause & exit 6

:: create android project
set /P _PACKAGEPATH=Please enter your package path. For example: org.cocos2dx.example:
::set /P _PACKAGEPATH=org.cocos2dx.TestCocos2D
set /P _PROJECTNAME=lease enter your project name:
...
set _CYGSCRIPT=/D/cocos2d-2.1rc0-x-2.1.3/create-android-project.sh

:: Resolve current dir to cygwin path
::for /f "delims=" %%A in ('%_CYGBIN%\cygpath.exe "%cd%"') do set _CURRENTDIR=%%A
set _CURRENTDIR=/D/cocos2d-2.1rc0-x-2.1.3
